...
export const ViewInicio = ({ setView }) => {
  ...
  useEffect(() => {
    ...
    // NUEVO: Agregamos allTypes como parámetro
    const processData = (allDocs, allEntities, allTypes) => {
      
      // Función para traducir el ID del tipo a un nombre real
      const getDocName = (doc) => {
        ...
        // Si tiene ambos, los combina. Si no, usa el que exista. Si ninguno existe, usa el genérico.
      ...
      // EXTRAER TODAS LAS FIRMAS PENDIENTES (y agregarles el nombre real)
      ...
      // Extraer Alertas Críticas (y agregarles el nombre real)
    ...
    // FASE B: Fetch silencioso
    const fetchFreshData = async () => {
      setIsSyncing(true);
      try {
        // Volvemos a traer los document-types para poder traducir los nombres
                  ...
                  <div key={doc.id} className="flex justify-between items-center bg-red-50 p-3 rounded-lg border border-red-100 mb-2 hover:shadow-md transition">
                    <div className="flex items-center gap-3 overflow-hidden">
                      ...
                      <div className="min-w-0">
                        {/* AHORA USA EL NOMBRE REAL TRADUCIDO */}
