export function SyncProgressOverlay({ active, percent }) {
  ...
  return (
    <div className="absolute left-0 right-0 top-0 z-[100] pointer-events-none">
      ...
      <div className="absolute right-2 top-1 text-[10px] font-semibold text-gray-500 dark:text-slate-300 bg-white/85 dark:bg-slate-900/90 px-1.5 py-0.5 rounded shadow-sm">
        {safePercent}%
      </div>
    </div>
  );
